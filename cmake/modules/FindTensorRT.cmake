...
set(DEP_LIBRARY CUDA)
ConfigDepLibPath(DEPS DEP_LIBRARY)

set(_TensorRT_SEARCHES)

if(TensorRT_DIR)
    set(_TensorRT_SEARCH_ROOT PATHS ${TensorRT_DIR} ENV{TensorRT_DIR} NO_DEFAULT_PATH)
...
message(STATUS "TensorRT_DIR: ${TensorRT_DIR}; Search_Dir: ${_TensorRT_SEARCHES}")
...
if(TensorRT_FOUND)
    set(TensorRT_INCLUDE_DIRS ${TensorRT_INCLUDE_DIR} ${DEPS_INCLUDE_DIRS})

    if(NOT TensorRT_LIBRARIES)
        set(TensorRT_LIBRARIES ${TensorRT_LIBRARY} ${TensorRT_NVONNXPARSER_LIBRARY} ${TensorRT_NVPARSERS_LIBRARY} ${DEPS_LIBS})
    endif()
